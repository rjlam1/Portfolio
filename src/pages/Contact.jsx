...
//                     <span className="absolute inset-0 transition-all duration-300 scale-75 bg-green-500 rounded-full opacity-0 hover:opacity-10 hover:scale-100" />
//                   </motion.a>
//                 ))}
//               </div>
//             </motion.div>
...
//             ref={form}
//             onSubmit={sendEmail}
//             className={`p-8 rounded-xl shadow-sm space-y-6 border transition-all 
//               ${isDark
